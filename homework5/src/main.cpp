...
int main() {
    // Box
    filesystem::path inputDir1("../examples/box/input");
    filesystem::path outputDir1("../examples/box/output");
    //int frameNum = 20;
    int frameNum = 20;
    ...
    //Denoise(inputDir1, outputDir1, frameNum);
    Denoise(inputDir2, outputDir2, frameNum);
    return 0;
}